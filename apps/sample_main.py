    ...
    return html.Div([
        ...
        html.Div([
                dbc.Row([
                    ...
                    dbc.Button("Click me", id="plm_report_mondule_button", className="mr-2"),
                ]),
                dbc.Row([
                    html.Div(id='plm_report_mondule'),
                ]),
            ],style={'margin': '35px'}),
...
@app.callback(
    Output('plm_report_mondule', 'children'),
    Input('plm_report_mondule_button', 'n_clicks'),
