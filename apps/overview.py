...
def get_layout(search):
    ...
    Fund_Facts = html.Div(
        [
            ...
            make_dash_table(df_fund_facts),
        ],
    )

    Average_annual_performance=html.Div(
        [
            html.H6(
    ...
    Price_Performance=html.Div(
        [
            html.H6(
                "Price & Performance (%)",
                className="subtitle padded",
            ),
            make_dash_table(df_price_perf),
        ],
        className="six columns",
    )
    ...
    return html.Div([
        dbc.Row(dbc.Col(Product_Summary)),
        html.Br([]),
        dbc.Row([
                dbc.Col([
                    Fund_Facts,
